...
* Data stewards, standards specialists, social scientists, engineers
...
![pip install direct from git into notebook](images/one_shot_install.png)
...
![quickly read a small window from a very large tiff file](images/rasterio_s3_window.png)
